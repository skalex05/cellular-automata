...
class Settings:
    def __init__(self, speed=10,
        ...
        self.screen_size_in_cells = screen_size // cell_size  # DEPENDENCIES: cell_size, screen_size

        self.initialising = False

        self.camera_position = grid_size // 2  # CONNECTED TO: camera_far_pos
        if camera_position:
    ...
    def __setattr__(self, name, value):
        ...
        if name == "speed":
            ...
            value = int(value)
            self.__dict__[name] = value
            self.screen_size_in_cells = self.screen_size // value

        elif name == "screen_size":
            self.__dict__[name] = value
            self.screen_size_in_cells = value // self.cell_size
            ...
            self.camera_far_pos = value + self.screen_size_in_cells
